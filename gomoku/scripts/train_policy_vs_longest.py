...
# -----------------------------------------------
# 連を伸ばす・相手の連を止める際の報酬設定
#   config_defaults.py の既定値よりも高くし、
#   攻撃的な手を評価するように調整している
# -----------------------------------------------
ENV_PARAMS = {
    # -------- 攻撃側（自分の連を作る） --------
    # 両端が空いた二連を作ったときの報酬
    "reward_chain_2_open2": 0.05,  # default: 0.01
    # 両端が空いた三連を作ったときの報酬
    "reward_chain_3_open2": 0.8,   # default: 0.5
    # 両端が空いた四連を作ったときの報酬
    "reward_chain_4_open2": 1.2,   # default: 0.8
    # 片端のみ空いた二連を作ったときの報酬
    "reward_chain_2_open1": 0.02,  # default: 0.0
    # 片端のみ空いた三連を作ったときの報酬
    "reward_chain_3_open1": 0.15,  # default: 0.05
    # 片端のみ空いた四連を作ったときの報酬
    "reward_chain_4_open1": 0.7,   # default: 0.4
